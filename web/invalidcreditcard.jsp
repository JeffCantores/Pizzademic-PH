...
<html lang="en">
  ...
  <title>Pizzademic PH - Error</title>
  </head>
  <body class="bg-dark">
	...
	<div class="jumbotron jumbotron-fluid bg-dark mb-5">
	  ...
	  <div class="container text-white mb-5">
	    <h1 class="display-4" style="color:red">INVALID CARD DETAILS!</h1>
	    <p class="lead">Kindly return to the products page and order another item, Thank you!</p>
	    
	    <hr class="my-4">
    		<a class="btn btn-secondary btn-lg" href="products.jsp" role="button">Back to Products Page</a>
  		</p>
	  </div>
	 </div>
